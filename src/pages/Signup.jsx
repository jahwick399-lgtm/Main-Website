    ...
    <div className="min-h-screen bg-dark flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 font-body text-sm">Create your free account</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6" style={{ border: '1px solid rgba(255,215,0,0.15)' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-white/50 font-body text-xs mb-1.5 uppercase tracking-widest">Confirm Password</label>
              <div className="relative">
                <input
          ...
          <div className="mt-5 text-center">
            <p className="text-white/30 font-body text-sm">
              ...
              <Link to="/login" className="font-semibold transition-colors" style={{ color: '#FFD700' }}>
                Log in
              </Link>
            </p>
          </div>
